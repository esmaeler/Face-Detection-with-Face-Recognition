...
def faceDetection(test_img):             
    ...
    face_haar=cv2.CascadeClassifier(r'C:\Users\Ismail\Desktop\facercognition\haarcascade_frontalface_default.xml') #Give path to haar classifier as i have given
